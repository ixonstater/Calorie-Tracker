...
import {
    Drawer, Box, Typography, TextField, List, ListItemButton, ListItemText, Chip, Button, Divider
} from '@mui/material';
    ...
    return (
        <Drawer anchor="bottom" open={open} onClose={onClose} PaperProps={{ sx: { maxHeight: '80vh', borderRadius: '16px 16px 0 0' } }}>
            <Box sx={{ width: '100%', px: 2, pt: 1 }}>
                {/* Drag handle */}
                <Box sx={{ width: 40, height: 4, bgcolor: 'divider', borderRadius: 2, mx: 'auto', mt: 1, mb: 2 }} />
